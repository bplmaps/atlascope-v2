  ...
  <div class="md:flex md:flex-row w-full">
    <div class="pt-2 pb-1 text-center">
      ...
      <div class="inline-flex items-center">
        <span class="mr-2 text-sm font-medium {!showView ? 'text-red-900' : 'text-gray-500'} text-center ">App link</span>
        ...
        <span class="ml-2 text-sm font-medium {showView ? 'text-red-900' : 'text-gray-500'} text-center">View link</span>
      </div>
